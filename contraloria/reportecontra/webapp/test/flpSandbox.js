		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#urnudpcontraloriareportecontra-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"urnudpcontraloriareportecontra-display": {
								"semanticObject": "urnudpcontraloriareportecontra",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=urn.udp.contraloria.reportecontra",
									"url": sap.ui.require.toUrl("urn/udp/contraloria/reportecontra")
								}
							}
						}
					}
